...
import com.t8rin.fancyslider.base.CustomSlider
import com.t8rin.fancyslider.base.CustomSliderDefaults.Track
import com.t8rin.fancyslider.base.CustomSliderState
import com.t8rin.fancyslider.modifier.container
import com.t8rin.fancyslider.modifier.materialShadow
import com.t8rin.fancyslider.modifier.trackOverslide
...
/**
 * A custom slider with fancy animations and visual effects.
 *
 ...
 * @param drawShadows whether to draw shadows for the slider thumb
 */
@Composable
fun FancySlider(
    value: Float,
