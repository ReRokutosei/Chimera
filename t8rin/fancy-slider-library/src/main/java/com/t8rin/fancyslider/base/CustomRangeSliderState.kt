...
/**
 * Class that holds information about [com.t8rin.fancyslider.base.CustomRangeSlider]'s active range.
 *
...
class CustomRangeSliderState(
    ...
    /**
     * [Float] that indicates the start of the current active range for the [com.t8rin.fancyslider.base.CustomRangeSlider].
     */
    ...
    /**
     * [Float] that indicates the end of the current active range for the [com.t8rin.fancyslider.base.CustomRangeSlider].
     */
    ...
    internal val gestureEndAction: (Boolean) -> Unit = { _ ->
    ...
    internal val startSteps
        get() = kotlin.math.floor(steps * coercedActiveRangeEndAsFraction).toInt()

    internal val endSteps
        get() = kotlin.math.floor(steps * (1f - coercedActiveRangeStartAsFraction)).toInt()
    ...
    private fun scaleToUserValue(
        ...
        scale(minPx, maxPx, offset.start, valueRange.start, valueRange.endInclusive),
        scale(minPx, maxPx, offset.endInclusive, valueRange.start, valueRange.endInclusive)
    )
...
internal data class CustomSliderRange(val start: Float, val endInclusive: Float)